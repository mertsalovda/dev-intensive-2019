...
import ru.mertsalovda.devintensive.extensions.TimeUnits
import ru.mertsalovda.devintensive.extensions.add
...
object DataGenerator {
    ...
    /**
     * Получить список пользователей [User]
     *
     * @param count колличество пользователй в списке
    ...
    /**
     * Получить список чатов [Chat]
     *
     * @param count колличество чатов
     * @return список чатов
     */
     ...
     * Получить список чатов [Chat]
     *
     * @param count колличиство чатов
     * @param hasGroups флаг наличия в списке групповых чатов
     * @return список чатов
     */
    ...
    /**
     * Получить список чатов с определённого идентификатора
     *
     * @param startId смещение для идентификаторов
     * @param count колличество чатов
     * @return список чатов
     */
    ...
    /**
     * Сгенерировать список случайных сообщений типа [BaseMessage]
     *
     * @param chat чат назначения сообщения
     * @param users отправитель сообщения
    ...
    /**
     * Получить случайного пользователя [User] из списка
     *
     * @param users список пользователй
     * @return случайного пользователя
     */
    ...
    /**
     * Получить случайное значение даты и флага нахождения в сети
     *
     * @return пара [Date] и isOnline
     */
